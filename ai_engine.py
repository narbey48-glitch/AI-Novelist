...
def call_ai(system_prompt, user_prompt):
    ...
    All AI requests now flow through ai_router.generate(),
    allowing future provider changes without modifying the
    remainder of ai_engine.py.
    """
...
def extract_chapter_word_target(
    ...
    for pattern in patterns:
        match = re.search(pattern, chapter_plan, re.IGNORECASE)
        if match:
            try:
